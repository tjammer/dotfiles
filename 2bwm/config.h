...
static const char *rofi[] = {"rofi", "-combi-modi", "window,drun,run", "-show", "combi", "-modi", "combi", NULL};
 ...
 *6)emptycol         */
static const char *colors[] = {"#88c0d0","#333333","#7a8c5c","#ff6666","#cc9933","#2e3440","#000000"};
...
static key keys[] = {
    ...
    // Backlight
    {  0x000000,          0x1008ff02,    start,             {.com = lightup}},
    {  0x000000,          0x1008ff03,    start,             {.com = lightdown}},
